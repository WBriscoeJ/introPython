...
# In your own words describe, what a computer program is?
 #A computer program is a sequence or a set of instructions in a programming language  for a computer to 
 #execute.
...
# In your own words, describe what it mean to call a function? 
 #In my own word calling a function gives commands so the that  computer  will run  the code for that 
...
# by the third argument. You function should then print theresult.
    
def customCalulation(arg1, arg2, arg3):
    result = (arg1+arg2)/arg3
    print(result)

customCalulation(1,2,3##)
